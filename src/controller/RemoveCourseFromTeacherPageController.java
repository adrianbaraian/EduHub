...
public class RemoveCourseFromTeacherPageController implements Initializable {
    ...
    public void updateTable() {
        ...
        listC = CourseRepository.getDataCoursesByTeacher(selectedTeacherID);
    ...
    void onRemoveCourseButtonClick() {
        ...
        adminRepository.removeCourseFromTeacher(selectedTeacherID, selectedCourseID);
